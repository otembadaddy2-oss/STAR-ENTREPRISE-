// STAR ALERTE — Service Worker (installation & fonctionnement hors-ligne)
const CACHE = "star-alerte-v1";
const CORE_ASSETS = [
  "./",
  "index.html",
  "confidentialite.html",
  "manifest.json",
  "assets/css/star-alerte.css",
  "assets/js/star-alerte.js",
  "assets/img/star-alerte-badge.png",
