...
(async () => {
  ...
  await page.goto('http://localhost:8097/etude-marche.html', { waitUntil: 'networkidle' });
  ...
  await page.pdf({
    path: '/tmp/claude-0/-home-user-STAR-ENTREPRISE-/715425df-146b-5238-85e4-85639de53306/scratchpad/etude_marche/etude-marche-ecommerce-afrique.pdf',
